<? include "header.php"; ?>
 <img src="./images/formulakd-banner-progressive.jpg" class='img-fluid all-width' alt="">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-3 col-6 text-center">
                <img src="./images/service-image-1.jpg" class='img-fluid rounded-circle' alt="">
                <a href="#" class=''>Проектирование <br>и расчеты</a>
            </div>
            <div class="col-md-3 col-6  text-center">
                <img src="./images/service-image-2.jpg" class='img-fluid rounded-circle' alt="">
                <a href="#" class=''>Разработка <br>документации</a>
            </div>
            <div class="col-md-3 col-6  text-center">
                <img src="./images/service-image-3.jpg" class='img-fluid rounded-circle' alt="">
                <a href="#" class=''>Изготовление <br>оборудования</a>
            </div>
            <div class="col-md-3 col-6 text-center">
                <img src="./images/service-image-4.jpg" class='img-fluid rounded-circle' alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mt-3">
                    <img src="./images/service-image-3.jpg" class='img-fluid' alt="">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-4"><img src="./images/about-image-1.jpg" class='img-fluid' alt=""></div>
                    <div class="col-md-8">ШИРОКИЙ ОПЫТ РАБОТЫ ПО ПРОЕКТИРОВАНИЮ И ИЗГОТОВЛЕНИЮ НЕСТАНДАРТНОГО И ИСПЫТАТЕЛЬНОГО ОБОРУДОВАНИЯ</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-4"><img src="./images/about-image-2.jpg" class='img-fluid' alt=""></div>
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-4"><img src="./images/about-image-3.jpg" class='img-fluid' alt=""></div>
    ...
    <div class="container mt-3">
     ...
     <div class="container dark-panel mt-3">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-4 text-center">
                        <img src="./images/step-icon-2.svg" style='height: 100px' class='img-fluid' alt="">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="./images/step-icon-3.svg" style='height: 100px' class='img-fluid' alt="">
                        <div class="step-description">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="./images/step-icon-4.svg" style='height: 100px' class='img-fluid' alt="">
                        <div class="step-description">
            ...
            <div class="col-md-3">
                <img src="./images/lump.jpg" class='img-fluid' alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-3">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <img src="./images/map-icon-1.jpg" class='img-fluid small' alt="">
                        <p>Организация транспортных услуг по доставке оборудования</p>
                    </div>
                    <div class="col-md-12 text-center">
                        <img src="./images/map-icon-2.svg" class='img-fluid small' alt="">
                        <p>Послепродажное обслуживание и гарантия качества оборудования</p>
                    </div>
                    <div class="col-md-12 text-center">
                        <img src="./images/map-icon-3.svg" class='img-fluid small' alt="">
                        <p>Организация и проведение первичной аттестации оборудования</p>
                    </div>
                    <div class="col-md-12 text-center">
                        <img src="./images/map-icon-4.svg" class='img-fluid small' alt="">
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-12"><img src="./images/map.jpg" class='img-fluid' alt=""></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-1.jpg" style='width: 80%' class='img-fluid' alt="">
                </div>
            ...
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-2.jpg" class='img-fluid' alt="">
                </div>
                <p>АО «Концерн ВКО
                    <br>«Алмаз-Антей»</p>
            </div>
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-3.jpg" style='width: 75%' class='img-fluid' alt="">
                </div>
                <p>АО
                    <br>«НИПТБ ОНЕГА»</p>
            </div>
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-4.jpg" class='img-fluid' alt="">
                </div>
                <p>АО «Саратовский
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-5.jpg" style='width: 80%' class='img-fluid' alt="">
                </div>
                <p>АО
            ...
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-6.jpg" style='width: 80%' class='img-fluid' alt="">
                </div>
                <p>ООО
                    <br>«Луидор Тюнинг»</p>
            </div>
            <div class="col-md-3 text-center">
                <div class="partner-logo-wrap">
                    <img src="./images/customer-logo-7.jpg" style='width: 80%' class='img-fluid' alt="">
                </div>
